...
<form method="post" action=<?php echo base_url()."index.php/Logincontroller/login";?>>
     ...
     <table>
  <tr><td>login as:</td><td><img src="<?php echo $pic;?>" class="img-responsive" style="width: 50px; height: 50px;"></td><td style="padding:0px;"><?php echo $fname;?>&nbsp;<?php echo $lname;?></td><input type="text" name="user" hidden="hidden" value="<?php echo $uname;?>"></tr>
  <tr><td>password:</td><td><input type="password" name="password" placeholder="password" style="border-color: red;"> </td></tr>
<tr><td></td><td><input type="checkbox" name="c" checked="checked">Keep me logged in</td></tr>
