...
<div class="container-fluid">
  ...
  <div class="row r1">
   <div class="col-md-6 col-lg-6 col-md-offset-0 col-lg-offset-0 col-sm-offset-0 col-sm-12 col-xs-offset-0 col-xs-12 " style="background-color: #3b5998; padding-top: 20px; height: 100px;">
  ...
  <div class="col-md-2 col-lg-2 col-md-offset-0 col-lg-offset-0 hidden-sm hidden-xs " style="background-color: #3b5998; height: 100px; padding-top: 35px;">
<input type="text" name="user" placeholder="username" style="padding-right:10px; "> 
  </div>
  <div class="col-md-2 col-lg-2 col-md-offset-0 col-lg-offset-0 hidden-sm hidden-xs   w" style="background-color: #3b5998; height: 100px; padding-top: 35px;">
<input type="password" name="password" placeholder="password" style="padding-right:10px;"> 
  </div>
  
  <div class="col-md-2 col-lg-2 col-md-offset-0 col-lg-offset-0 hidden-sm hidden-xs  e" style="background-color: #3b5998; height: 100px; padding-top: 35px;">
...
<input type="button" name="btn" class="btn-primary" value="LOGIN">
   ...
   <div class="row">
   <div class="col-md-12 col-lg-12 col-md-offset-0 col-lg-offset-0 hidden-xs hidden-sm r2"  style="background-color: #dfe3ee;">
   	
   </div>
    <div class="col-md-6 col-lg-6 col-md-offset-0 col-lg-offset-0 hidden-xs hidden-sm" style="background-color: #dfe3ee; height:536px;">
  ...
  <div class="col-md-6 col-lg-6 col-md-offset-0 col-lg-offset-0 hidden-xs hidden-sm r4" style="background-color: #dfe3ee; height:536px;">
