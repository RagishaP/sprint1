...
<div class="col-md-6 col-lg-6 col-md-offset-0 col-lg-offset-0 hidden-xs hidden-sm " style="background-color: #3b5998; height: 100px; padding-top: 35px;">
   ...
   <div class="row m" style="height:400px;background-color: #dfe3ee;">
   <div class="col-md-12 col-lg-12 col-md-offset-0 col-lg-offset-0 hidden-xs hidden-sm r2">
    
   </div>
    <div class="col-md-6 col-lg-6 col-md-offset-3 col-lg-offset-3  col-sm-offset-0 col-sm-12 col-xs-offset-0 col-xs-12 v">
     <h2>Facebook Login</h2><hr>

    <form method="post" action=<?php echo base_url()."index.php/Logincontroller/login";?>>
   <table>
<tr><td style="padding-left:80px;">Email or Phone:</td><td style="padding-left:0px; border-color: red;"><input type="text" name="user"><span class="glyphicon glyphicon-warning-sign" style="color: red;"></span></td><!-- <td>The email address that you have entered dosen't match any account.Sign up for an account.</td> --></tr>
<tr><td></td></tr>
...
<tr><td></td><td><span style="color:#0066ff;">Forgotten password?</span></td></tr>
   ...
   <div class="row n">
   <div class="col-md-12 col-lg-12 col-md-offset-0 col-lg-offset-0 col-sm-offset-0 col-sm-12 col-xs-offset-0 col-xs-12 r2">
